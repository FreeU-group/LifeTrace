    ...
    return (
      <WorkspaceContainer
        ...
        editorLabels={{
          ...
          // 幻灯片生成
          generateSlidesLabel: t.workspace.generateSlides,
          generatingSlidesLabel: t.workspace.generatingSlides,
          generateSlidesDescLabel: t.workspace.generateSlidesDesc,
          slidesGeneratedLabel: t.workspace.slidesGenerated,
          slideGeneratingLabel: t.workspace.slideGenerating,
          slideDoneLabel: t.workspace.slideDone,
          slideErrorLabel: t.workspace.slideError,
          totalSlidesLabel: t.workspace.totalSlides,
          slidesConfirmTitle: t.workspace.slidesConfirmTitle,
          slidesConfirmMessage: t.workspace.slidesConfirmMessage,
          slidesConfirmConfirm: t.workspace.slidesConfirmConfirm,
          slidesConfirmCancel: t.workspace.slidesConfirmCancel,
          slidesModalLabels: t.workspace.slidesModal,
